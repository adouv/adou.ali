          ...
          <div class="modal-dialog" :class="modalOptions.position">
              <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <button type="button" class="btn btn-default" @click="btnClose();">{{modalOptions.cleanText}}</button>
                      <button type="button" class="btn btn-primary" v-if="modalOptions.showSave" @click="btnSave();">{{modalOptions.saveText}}</button>
                  </div>
              </div>
          </div>
      </div>
